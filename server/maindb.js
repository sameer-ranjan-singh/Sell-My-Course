...
const { default: Courses } = require('../client/src/Courses');
...
mongoose.connect('mongodb+srv://sameer:16HJiW8i5sJX2VkE@cluster1-smc.pltg39i.mongodb.net/courses', { useNewUrlParser: true, useUnifiedTopology: true, dbName: "courses" });
